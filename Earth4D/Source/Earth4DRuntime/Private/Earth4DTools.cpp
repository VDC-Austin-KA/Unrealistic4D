...
TEXT(R"JSON({"name":"set_project_start","description":"Set the project start date (ISO-8601, e.g. 2026-03-01), the day-0 anchor for the schedule.","input_schema":{"type":"object","properties":{"date":{"type":"string"}},"required":["date"]}},
